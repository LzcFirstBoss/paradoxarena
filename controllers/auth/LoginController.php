           ...
           // Verifica se já existe um código cadastrado para o usuário
            ...
            if ($existingToken) {
                ...
                if ($tokenExpiresAt > $currentTime) {
                    ...
                    $_SESSION['sucesso'] = "Um código de verificação já foi enviado e ainda está válido. Por favor, aguarde até que ele expire para solicitar um novo. <a href='/login'>Não recebi o código</a>";
